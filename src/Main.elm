...
update msg model =
    case msg of
        ...
        SaveProduct product ->
            ( model
            , Http.request
                { url = model.apiUrl ++ "/esprods/" ++ String.fromInt product.id
        ...
        RefreshStock pid ->
            ( model
            , Http.post
                { url = model.apiUrl ++ "/syncstock/" ++ String.fromInt pid
                , expect = Http.expectWhatever ProductUpdated
                , body = Http.emptyBody
                }
            )
        ...
        DeleteProduct i ->
            ( model
            , Http.request
                { url = model.apiUrl ++ "/esprods/" ++ String.fromInt i
    ...
    div [ Attrs.class "container-fluid" ]
        [ div [ Attrs.class "row" ]
            [ div [ Attrs.class "col-sm-4" ]
                [ div [ Attrs.class "h3", Attrs.class "text-center" ] [ text "E-shop products" ]
                , div [] [ text model.wtf ]
                ]
            ]
        , div [ Attrs.class "row" ]
        ...
        , div [ Attrs.class "row" ]
            [ div [ Attrs.class "col-sm-3", Attrs.class "d-grip", Attrs.class "gap-3" ]
                [ div []
                    (List.map
                        (\prod ->
                            div [ Attrs.class "card", Attrs.class "p-2", Attrs.class "mb-sm-3", Attrs.class "text-bg-dark", Attrs.style "background-color" "rgb(211, 183, 146)" ]
                                ...
                                , div [ Attrs.class "col-sm-8", Attrs.class "text-right" ]
                                    [ div [ Attrs.class "row" ]
                                        ...
                                        , div [ Attrs.class "col-sm-4" ]
                                            [ a [ Attrs.href "#", Attrs.class "float-end" ]
                                                [ i [ Attrs.class "bi", Attrs.class "bi-arrow-clockwise", Events.onClick (RefreshStock prod.id) ] []
                                                ]
                                            ]
                                        ]
                                    , div [ Attrs.class "row" ]
